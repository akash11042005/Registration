...
import { GraduationCap, Users, CheckCircle2, XCircle, AlertTriangle } from 'lucide-react';
      ...
      <div className="page-header pt-24 pb-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-metal-300 text-body-lg max-w-2xl">
            AAYODHYAM 2026 is open to undergraduate engineering students across India. Review the criteria before registering.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
        ...
        <motion.div {...fadeInUp} className="card p-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              { ok: true, text: 'B.Tech students (2nd and 3rd year) from any engineering college' },
              { ok: true, text: 'Students from AICTE-approved / university-affiliated colleges across India' },
              { ok: true, text: '2nd year students from WCE Sangli' },
