...
const INITIAL_REGISTRATIONS: Registration[] = [
  {
    ...
    leaderYear: '3rd Year',
    leaderBranch: 'Mechanical Engineering',
    member1Name: 'Rahul Sharma',
    member2Name: 'Priya Patel',
    taskId: 1,
  ...
  },
  {
    ...
    leaderYear: '2nd Year',
    leaderBranch: 'Metallurgy & Materials Engineering',
    member1Name: 'Sneha Kulkarni',
    member2Name: 'Rohan Joshi',
    taskId: 3,
