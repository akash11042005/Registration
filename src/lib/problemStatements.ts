...
export const PROBLEM_STATEMENTS: ProblemStatement[] = [
  ...
  {
    id: 5,
    title: 'App-Based Cast Iron Nodularity Measurement',
    category: 'Metallography',
    difficulty: 'Medium',
    mode: 'Online/Offline',
